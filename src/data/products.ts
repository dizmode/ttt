...
export const products: Product[] = [
  ...
  {
    id: 'shirt-lucky-red-001',
    sku: 'ITEM-001',
    name: 'Lucky T-Shirt Red',
    category: 'T-Shirts',
    description: 'Single print lucky logo.',
    price: 20,
    stock: 1,
    image: '/lucky-t-shirt-red.png',
  },
  {
    id: 'shirt-stock-001',
    sku: 'STOCK-001',
    name: 'KittiespinkTee',
    category: 'T-Shirts',
    description: 'Kittie design pink tee.',
    price: 20,
    stock: 1,
    image: '/images/ttt-stok/1.jpg',
  },
  {
    id: 'shirt-stock-002',
    sku: 'STOCK-002',
    name: 'Lucky Red Tee',
    category: 'T-Shirts',
    description: 'Lucky design red tee.',
    price: 20,
    stock: 1,
    image: '/images/ttt-stok/2.jpg',
  },
  {
    id: 'shirt-stock-003',
    sku: 'STOCK-003',
    name: 'Luckyhood',
    category: 'Hoodies',
    description: 'Lucky design hoodie.',
    price: 60,
    stock: 1,
    image: '/images/ttt-stok/3.jpg',
  },
  {
    id: 'shirt-stock-004',
    sku: 'STOCK-004',
    name: 'kittiesgreen',
    category: 'T-Shirts',
    description: 'Kittie design green tee.',
    price: 20,
    stock: 1,
    image: '/images/ttt-stok/4.jpg',
  },
  {
    id: 'shirt-stock-005',
    sku: 'STOCK-005',
    name: 'trtlegreenTee',
    category: 'T-Shirts',
    description: 'Turtle design green tee.',
    price: 20,
    stock: 1,
    image: '/images/ttt-stok/5.jpg',
  },
];
